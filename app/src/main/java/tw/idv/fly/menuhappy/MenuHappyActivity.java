 ...
 */
public class MenuHappyActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_happy);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            String url = getResources().getString(R.string.api_url) + "api/Login/SignIn";
            StringRequest reqeust = new StringRequest(Request.Method.POST, url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            Gson gson = new Gson();
                            LoginMessage p = gson.fromJson(response, LoginMessage.class);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(MenuHappyActivity.this,
